...
<div
  className={`
    ...
    ${variant === "popup" ? "bg-white dark:bg-gray-900 p-6 rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto relative outline-none custom-scrollbar" : ""}
  `}
  tabIndex={-1}
>
      {variant === "popup" && onClose && (
        <button
          onClick={onClose}
          className="absolute top-1 right-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 text-xl font-bold"
          aria-label="Close"
        >
          &times;
        </button>
