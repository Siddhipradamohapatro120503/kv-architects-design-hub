      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4">
          {brandImages.map((brand, index) => (
            ...
            >
              <div className="h-[20rem] sm:h-[25rem] md:h-[30rem] border-t border-white/20 border-r last:border-r-0 md:last-of-type:border-r md:[&:nth-child(4)]:border-r-0">
                <div className="h-full flex items-center justify-center p-8 transition-all duration-300 group-hover:bg-gray-800/50">
